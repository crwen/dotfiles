...
export TMUX_POWERLINE_WINDOW_STATUS_CURRENT='#[fg=magenta,bold] #I #W:#F'
export TMUX_POWERLINE_WINDOW_STATUS_FORMAT='#[fg=brightblue] #I #W '
...
# sqlite3 -list "/var/folders/9f/brghgmrs16b8zhxhbmf6lkx40000gp/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/crwen/.mail/inbox/new"
...
export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/crwen/.mailcheckrc"
# }
